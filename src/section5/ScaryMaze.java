...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	maze = ImageIO.read(getClass().getResource("game.png"));
...
AudioClip sound = JApplet.newAudioClip(getClass().getResource("violin.wav"));
